...
import 'package:super_app/core/models/user_model.dart';
...
class AuthCubit extends Cubit<AuthState> {
  ...
  Future<void> createNewUser() async {
    ...
    try {
      Map<String, dynamic> data =
          await ApiService.createNewUser(userModel: user);
  ...
  Future<void> login(
    ...
    try {
      Map<String, dynamic> data = await ApiService.login(
          userEmail: userEmail, userNID: userNID, userPass: userPass);
