...
class ApiService {
  static String createNewUserBaseUrl =
      'https://super-app-backend.onrender.com/users/createNewUser';
  static String loginBaseUrl =
      'https://super-app-backend.onrender.com/users/signIn';

  static String scanQrCodeBaseUrl =
      'https://super-app-backend.onrender.com/accessControl/addAccessControlEntry';
  ...
  static Future<Map<String, dynamic>> createNewUser(
    ...
    if (originalImage != null) {
      final img.Image resizedImage =
          img.copyResize(originalImage, width: 300); // resize to a smaller size
      final String compressedImage = base64Encode(
          img.encodeJpg(resizedImage, quality: 85)); // compress the image
  ...
  static Future<Map<String, dynamic>> login(
    ...
    final Response response = await dio.post(
      ...
      options: Options(validateStatus: (status) {
        return status! <
            500; // Accept responses with status codes less than 500
      }),
    );
  ...
  static Future<Map<String, dynamic>> scanQrCode(
      {required String agentId, required String consumerId}) async {
    final Dio dio = Dio();
    final Map<String, dynamic> data = {
      "agentId": agentId,
